 ...
 * @internal    @properties  &position=Position on dashboard;text;2 &width=Widget width (12 or 6);text;12 &part=Number of requests at a time;text;5 &wdgVisibility=Show widget for:;menu;All,AdminOnly,AdminExcluded,ThisRoleOnly,ThisUserOnly;All &ThisRole=Run only for this role:;string;;;(role id) &ThisUser=Run only for this user:;string;;;(username)
